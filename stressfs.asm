 ...
 701:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 73d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 73f:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 744:	5b                   	pop    %ebx
 745:	5e                   	pop    %esi
 746:	5f                   	pop    %edi
 ...
 756:	72 ce                	jb     726 <free+0x26>
{
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 80 0b 00 00       	mov    %eax,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 15 80 0b 00 00    	mov    0xb80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 47                	jae    828 <malloc+0x98>
    ...
    if(p == freep)
 7e1:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 806:	e8 f5 fe ff ff       	call   700 <free>
  return freep;
 80b:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 857:	0b 00 00 
 85a:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 861:	0b 00 00 
    base.s.size = 0;
 864:	b8 84 0b 00 00       	mov    $0xb84,%eax
 869:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 870:	00 00 00 

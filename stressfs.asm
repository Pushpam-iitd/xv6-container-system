 ...
 6f1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 60 0b 00 00    	mov    0xb60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 60 0b 00 00    	cmp    %eax,0xb60
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 847:	0b 00 00 
 84a:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 851:	0b 00 00 
    base.s.size = 0;
 854:	b8 64 0b 00 00       	mov    $0xb64,%eax
 859:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 860:	00 00 00 

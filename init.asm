 ...
 6a1:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 40 0b 00 00    	mov    0xb40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 44 0b 00 00       	mov    $0xb44,%eax
 809:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 810:	00 00 00 

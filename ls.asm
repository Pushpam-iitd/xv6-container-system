 ...
 8f1:	a1 10 0e 00 00       	mov    0xe10,%eax
{
 ...
 92d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 92f:	a3 10 0e 00 00       	mov    %eax,0xe10
}
 934:	5b                   	pop    %ebx
 935:	5e                   	pop    %esi
 936:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 989:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 98c:	8b 15 10 0e 00 00    	mov    0xe10,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9cf:	73 47                	jae    a18 <malloc+0x98>
    ...
    if(p == freep)
 9d1:	39 05 10 0e 00 00    	cmp    %eax,0xe10
 ...
 9f6:	e8 f5 fe ff ff       	call   8f0 <free>
  return freep;
 9fb:	8b 15 10 0e 00 00    	mov    0xe10,%edx
 ...
 a24:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a27:	89 15 10 0e 00 00    	mov    %edx,0xe10
}
 ...
 a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a40:	c7 05 10 0e 00 00 14 	movl   $0xe14,0xe10
 a47:	0e 00 00 
 a4a:	c7 05 14 0e 00 00 14 	movl   $0xe14,0xe14
 a51:	0e 00 00 
    base.s.size = 0;
 a54:	b8 14 0e 00 00       	mov    $0xe14,%eax
 a59:	c7 05 18 0e 00 00 00 	movl   $0x0,0xe18
 a60:	00 00 00 

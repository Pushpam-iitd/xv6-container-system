...
free(void *ap)
{
 ...
 8e1:	a1 f0 0d 00 00       	mov    0xdf0,%eax
{
 ...
 91d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 91f:	a3 f0 0d 00 00       	mov    %eax,0xdf0
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 f0 0d 00 00       	mov    %eax,0xdf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 f0 0d 00 00    	mov    0xdf0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
    ...
    if(p == freep)
 9c1:	39 05 f0 0d 00 00    	cmp    %eax,0xdf0
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
  return freep;
 9eb:	8b 15 f0 0d 00 00    	mov    0xdf0,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a17:	89 15 f0 0d 00 00    	mov    %edx,0xdf0
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 f0 0d 00 00 f4 	movl   $0xdf4,0xdf0
 a37:	0d 00 00 
 a3a:	c7 05 f4 0d 00 00 f4 	movl   $0xdf4,0xdf4
 a41:	0d 00 00 
    base.s.size = 0;
 a44:	b8 f4 0d 00 00       	mov    $0xdf4,%eax
 a49:	c7 05 f8 0d 00 00 00 	movl   $0x0,0xdf8
 a50:	00 00 00 

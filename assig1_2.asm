...
main(int argc, char *argv[])
{
  ...
  18:	75 36                	jne    50 <main+0x50>
		create_container(2);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 02                	push   $0x2
  1f:	e8 46 03 00 00       	call   36a <create_container>
		join_container(2);
  24:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  2b:	e8 4a 03 00 00       	call   37a <join_container>
		ps();
  30:	e8 2d 03 00 00       	call   362 <ps>
    // char* s = "Rahul";
    int fd2 = open("arrnew",0);
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	6a 00                	push   $0x0
  39:	68 a8 07 00 00       	push   $0x7a8
  3e:	e8 af 02 00 00       	call   2f2 <open>
    // write(fd2,s,5);
    close(fd2);
  43:	89 04 24             	mov    %eax,(%esp)
  46:	e8 8f 02 00 00       	call   2da <close>
    // int fd3 = open("arrn", 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb af 07 00 00       	mov    $0x7af,%ebx
        while(*s != 0){

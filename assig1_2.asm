...
main(int argc, char *argv[])
{
  ...
  18:	75 4f                	jne    69 <main+0x69>
		create_container(2);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 02                	push   $0x2
  1f:	e8 56 03 00 00       	call   37a <create_container>
		join_container(2);
  24:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  2b:	e8 5a 03 00 00       	call   38a <join_container>
		ps();
  30:	e8 3d 03 00 00       	call   372 <ps>
    int fd2 = open("arrn", O_CREATE | O_RDWR);
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	68 02 02 00 00       	push   $0x202
  3c:	68 a8 07 00 00       	push   $0x7a8
  41:	e8 bc 02 00 00       	call   302 <open>
    close(fd2);
  46:	89 04 24             	mov    %eax,(%esp)
  49:	e8 9c 02 00 00       	call   2ea <close>
    int fd3 = open("arrn", 0);
  4e:	59                   	pop    %ecx
  4f:	58                   	pop    %eax
  50:	6a 00                	push   $0x0
  52:	68 a8 07 00 00       	push   $0x7a8
  57:	e8 a6 02 00 00       	call   302 <open>
    close(fd3);
  5c:	89 04 24             	mov    %eax,(%esp)
  5f:	e8 86 02 00 00       	call   2ea <close>
		exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb ad 07 00 00       	mov    $0x7ad,%ebx
        while(*s != 0){

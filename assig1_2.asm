...
main(int argc, char *argv[])
{
  ...
  1b:	0f 85 9a 00 00 00    	jne    bb <main+0xbb>
		create_container(1);
  21:	83 ec 0c             	sub    $0xc,%esp
  24:	8d 7d bf             	lea    -0x41(%ebp),%edi
  27:	6a 01                	push   $0x1
  29:	e8 9c 03 00 00       	call   3ca <create_container>
		join_container(1);
  2e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  35:	e8 a0 03 00 00       	call   3da <join_container>
		ps();
  3a:	e8 83 03 00 00       	call   3c2 <ps>
    int fd2 = open("arrnew", 0);
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	6a 00                	push   $0x0
  43:	68 f8 07 00 00       	push   $0x7f8
  48:	e8 05 03 00 00       	call   352 <open>
    printf(1,"returns  \n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  4f:	68 ff 07 00 00       	push   $0x7ff
  54:	6a 01                	push   $0x1
  56:	8d 5d c0             	lea    -0x40(%ebp),%ebx
    int fd2 = open("arrnew", 0);
  ...
  70:	57                   	push   %edi
  71:	56                   	push   %esi
  72:	e8 b3 02 00 00       	call   32a <read>
  		arr[i]=c-'0';
  77:	66 0f be 45 bf       	movsbw -0x41(%ebp),%ax
  		read(fd2, &c, 1);
  7c:	83 c4 0c             	add    $0xc,%esp
  		arr[i]=c-'0';
  7f:	83 e8 30             	sub    $0x30,%eax
  82:	66 89 43 fe          	mov    %ax,-0x2(%ebx)
  		read(fd2, &c, 1);
  86:	6a 01                	push   $0x1
  88:	57                   	push   %edi
  89:	56                   	push   %esi
  8a:	e8 9b 02 00 00       	call   32a <read>
    for(int i=0; i<size; i++){
  8f:	8d 45 e8             	lea    -0x18(%ebp),%eax
  92:	83 c4 10             	add    $0x10,%esp
  95:	39 c3                	cmp    %eax,%ebx
  97:	75 cf                	jne    68 <main+0x68>
  	}
    	close(fd2);
  99:	83 ec 0c             	sub    $0xc,%esp
  9c:	56                   	push   %esi
  9d:	e8 98 02 00 00       	call   33a <close>
    printf(1,"first elem %d\n", arr[0]);
  a2:	0f bf 45 c0          	movswl -0x40(%ebp),%eax
  a6:	83 c4 0c             	add    $0xc,%esp
  a9:	50                   	push   %eax
  aa:	68 0a 08 00 00       	push   $0x80a
  af:	6a 01                	push   $0x1
...
SYSCALL(join_container)
 3da:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3df:	cd 40                	int    $0x40
 3e1:	c3                   	ret    
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 4e0:	e8 4d fe ff ff       	call   332 <write>
 ...
 558:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 55a:	e8 d3 fd ff ff       	call   332 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5f3:	57                   	push   %edi
 5f4:	53                   	push   %ebx
 5f5:	e8 38 fd ff ff       	call   332 <write>
        while(*s != 0){
 ...
 647:	e8 e6 fc ff ff       	call   332 <write>
        ap++;
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 19 08 00 00       	mov    $0x819,%ebx
        while(*s != 0){
 ...
 671:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75e:	56                   	push   %esi
 75f:	e8 36 fc ff ff       	call   39a <sbrk>
  if(p == (char*)-1)
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 7c7:	0a 00 00 
 7ca:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 7d9:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7e0:	00 00 00 

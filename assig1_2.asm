...
main(int argc, char *argv[])
{
  ...
  int pid;
  pid = fork();
  14:	e8 01 03 00 00       	call   31a <fork>
  if (pid==0){
  19:	85 c0                	test   %eax,%eax
  1b:	0f 85 a2 00 00 00    	jne    c3 <main+0xc3>
		create_container(2);
  21:	83 ec 0c             	sub    $0xc,%esp
  24:	8d 7d bf             	lea    -0x41(%ebp),%edi
  27:	6a 02                	push   $0x2
  29:	e8 ac 03 00 00       	call   3da <create_container>
		join_container(2);
  2e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  35:	e8 b0 03 00 00       	call   3ea <join_container>
		ps();
  3a:	e8 93 03 00 00       	call   3d2 <ps>
    int fd2 = open("arrn", O_CREATE | O_RDWR);
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 02 02 00 00       	push   $0x202
  46:	68 08 08 00 00       	push   $0x808
  4b:	e8 12 03 00 00       	call   362 <open>
    printf(1,"returns  \n");
  50:	59                   	pop    %ecx
  51:	5b                   	pop    %ebx
  52:	68 0d 08 00 00       	push   $0x80d
  57:	6a 01                	push   $0x1
  59:	8d 5d c0             	lea    -0x40(%ebp),%ebx
    int fd2 = open("arrn", O_CREATE | O_RDWR);
  ...
  78:	57                   	push   %edi
  79:	56                   	push   %esi
  7a:	e8 bb 02 00 00       	call   33a <read>
  		arr[i]=c-'0';
  7f:	66 0f be 45 bf       	movsbw -0x41(%ebp),%ax
  		read(fd2, &c, 1);
  ...
  90:	57                   	push   %edi
  91:	56                   	push   %esi
  92:	e8 a3 02 00 00       	call   33a <read>
    for(int i=0; i<size; i++){
  97:	8d 45 e8             	lea    -0x18(%ebp),%eax
  9a:	83 c4 10             	add    $0x10,%esp
  9d:	39 c3                	cmp    %eax,%ebx
  9f:	75 cf                	jne    70 <main+0x70>
  	}
    	close(fd2);
  a1:	83 ec 0c             	sub    $0xc,%esp
  a4:	56                   	push   %esi
  a5:	e8 a0 02 00 00       	call   34a <close>
    printf(1,"first elem %d\n", arr[0]);
  aa:	0f bf 45 c0          	movswl -0x40(%ebp),%eax
  ae:	83 c4 0c             	add    $0xc,%esp
  b1:	50                   	push   %eax
  b2:	68 18 08 00 00       	push   $0x818
  b7:	6a 01                	push   $0x1
  b9:	e8 f2 03 00 00       	call   4b0 <printf>
		exit();
  be:	e8 5f 02 00 00       	call   322 <exit>
	}
	else{
		exit();
  c3:	e8 5a 02 00 00       	call   322 <exit>
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
  ce:	66 90                	xchg   %ax,%ax
...
00000402 <recv>:
SYSCALL(recv)
 402:	b8 1e 00 00 00       	mov    $0x1e,%eax
 407:	cd 40                	int    $0x40
 409:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 4f0:	e8 4d fe ff ff       	call   342 <write>
 ...
 568:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 56a:	e8 d3 fd ff ff       	call   342 <write>
  for(i = 0; fmt[i]; i++){
 ...
 603:	57                   	push   %edi
 604:	53                   	push   %ebx
 605:	e8 38 fd ff ff       	call   342 <write>
        while(*s != 0){
 ...
 657:	e8 e6 fc ff ff       	call   342 <write>
        ap++;
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 27 08 00 00       	mov    $0x827,%ebx
        while(*s != 0){
 ...
 681:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 76e:	56                   	push   %esi
 76f:	e8 36 fc ff ff       	call   3aa <sbrk>
  if(p == (char*)-1)
 ...
 7d7:	0a 00 00 
 7da:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7e1:	0a 00 00 
    base.s.size = 0;
 7e4:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 7e9:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7f0:	00 00 00 

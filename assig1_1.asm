...
main(void)
{
  ...
  28:	75 ea                	jne    14 <main+0x14>
    close(fd2);
		...
		exit();
  2a:	e8 b3 02 00 00       	call   2e2 <exit>
		create_container(k);
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	53                   	push   %ebx
  33:	e8 62 03 00 00       	call   39a <create_container>
		join_container(k);
  38:	89 1c 24             	mov    %ebx,(%esp)
  3b:	e8 6a 03 00 00       	call   3aa <join_container>
    int fd2 = open("arrn", O_CREATE | O_RDWR);
  40:	58                   	pop    %eax
  41:	5a                   	pop    %edx
  42:	68 02 02 00 00       	push   $0x202
  47:	68 e5 07 00 00       	push   $0x7e5
  4c:	e8 d1 02 00 00       	call   322 <open>
    write(fd2,s,5);
  ...
  54:	89 c3                	mov    %eax,%ebx
    write(fd2,s,5);
  56:	6a 05                	push   $0x5
  58:	68 ea 07 00 00       	push   $0x7ea
  5d:	50                   	push   %eax
  5e:	e8 9f 02 00 00       	call   302 <write>
    close(fd2);
  63:	89 1c 24             	mov    %ebx,(%esp)
  66:	e8 9f 02 00 00       	call   30a <close>
		ps();
  6b:	e8 22 03 00 00       	call   392 <ps>
		exit();
  70:	e8 6d 02 00 00       	call   2e2 <exit>
					printf(1,"fork failed\n");
  75:	51                   	push   %ecx
  76:	51                   	push   %ecx
  77:	68 d8 07 00 00       	push   $0x7d8
  7c:	6a 01                	push   $0x1
...
SYSCALL(destroy_container)
 3a2:	b8 19 00 00 00       	mov    $0x19,%eax
 3a7:	cd 40                	int    $0x40
 3a9:	c3                   	ret    

000003aa <join_container>:
SYSCALL(join_container)
 3aa:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3af:	cd 40                	int    $0x40
 3b1:	c3                   	ret    

000003b2 <leave_container>:
SYSCALL(leave_container)
 3b2:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3b7:	cd 40                	int    $0x40
 3b9:	c3                   	ret    

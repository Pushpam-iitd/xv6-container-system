...
main(void)
{
   ...
   f:	bb 01 00 00 00       	mov    $0x1,%ebx
			pid = fork();
  14:	e8 91 02 00 00       	call   2aa <fork>
			if (pid == -1) {
  19:	83 f8 ff             	cmp    $0xffffffff,%eax
  1c:	74 2c                	je     4a <main+0x4a>
  ...
  28:	75 ea                	jne    14 <main+0x14>
		...
		exit();
  2a:	e8 83 02 00 00       	call   2b2 <exit>
		create_container(k);
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	53                   	push   %ebx
  33:	e8 32 03 00 00       	call   36a <create_container>
		join_container(k);
  38:	89 1c 24             	mov    %ebx,(%esp)
  3b:	e8 3a 03 00 00       	call   37a <join_container>
		ps();
  40:	e8 1d 03 00 00       	call   362 <ps>
		exit();
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 bc 07 00 00 	movzbl 0x7bc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb b5 07 00 00       	mov    $0x7b5,%ebx
        while(*s != 0){

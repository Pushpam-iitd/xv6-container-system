...
main(int argc, char **argv)
{
  ...
  38:	e8 59 06 00 00       	call   696 <kill>
  for(i=1; i<argc; i++)
  3d:	83 c4 10             	add    $0x10,%esp
  40:	39 f3                	cmp    %esi,%ebx
  42:	75 e4                	jne    28 <main+0x28>
  exit();
  44:	e8 1d 06 00 00       	call   666 <exit>
    printf(2, "usage: kill pid...\n");
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  4b:	68 58 0b 00 00       	push   $0xb58
  50:	6a 02                	push   $0x2
  52:	e8 a9 07 00 00       	call   800 <printf>
    exit();
 ...
 769:	85 d2                	test   %edx,%edx
{
 ...
 797:	f7 f1                	div    %ecx
 799:	0f b6 92 cc 0b 00 00 	movzbl 0xbcc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 9b4:	e9 8f fe ff ff       	jmp    848 <printf+0x48>
          s = "(null)";
 9b9:	bb c3 0b 00 00       	mov    $0xbc3,%ebx
        while(*s != 0){

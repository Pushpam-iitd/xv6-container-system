...
create_container((int)*argv[1]);
  ...
  1a:	50                   	push   %eax
  1b:	e8 1a 03 00 00       	call   33a <create_container>
exit();
 ...
 5e1:	a1 20 0a 00 00       	mov    0xa20,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 20 0a 00 00       	mov    %eax,0xa20
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 737:	0a 00 00 
 73a:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 741:	0a 00 00 
    base.s.size = 0;
 744:	b8 24 0a 00 00       	mov    $0xa24,%eax
 749:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 750:	00 00 00 

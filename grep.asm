 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 40 18 00 00    	lea    0x1840(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 40 18 00 00       	mov    $0x1840,%ebx
    buf[m] = '\0';
 26c:	c6 86 40 18 00 00 00 	movb   $0x0,0x1840(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 40 18 00 00    	cmp    $0x1840,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 40 18 00 00       	sub    $0x1840,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 40 18 00 00       	push   $0x1840

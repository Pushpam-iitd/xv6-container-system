...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 9c 06 00 00       	call   6d6 <unlink>
...
printf(int fd, const char *fmt, ...)
{
 ...
 9d4:	e9 8f fe ff ff       	jmp    868 <printf+0x48>
          s = "(null)";
 9d9:	bb fc 0b 00 00       	mov    $0xbfc,%ebx
        while(*s != 0){

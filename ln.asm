 ...
 611:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 80 0a 00 00    	mov    0xa80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 80 0a 00 00    	cmp    %eax,0xa80
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 767:	0a 00 00 
 76a:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 84 0a 00 00       	mov    $0xa84,%eax
 779:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 780:	00 00 00 

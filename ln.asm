   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  17:	52                   	push   %edx
  18:	52                   	push   %edx
  19:	68 58 0b 00 00       	push   $0xb58
  1e:	6a 02                	push   $0x2
  20:	e8 db 07 00 00       	call   800 <printf>
    exit();
  25:	e8 3c 06 00 00       	call   666 <exit>
  }
  ...
  32:	e8 8f 06 00 00       	call   6c6 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 23 06 00 00       	call   666 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	pushl  0x8(%ebx)
  46:	ff 73 04             	pushl  0x4(%ebx)
  49:	68 6b 0b 00 00       	push   $0xb6b
  4e:	6a 02                	push   $0x2
  50:	e8 ab 07 00 00       	call   800 <printf>
 ...
 769:	85 d2                	test   %edx,%edx
{
 ...
 797:	f7 f1                	div    %ecx
 799:	0f b6 92 e0 0b 00 00 	movzbl 0xbe0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 9b4:	e9 8f fe ff ff       	jmp    848 <printf+0x48>
          s = "(null)";
 9b9:	bb d6 0b 00 00       	mov    $0xbd6,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 9d1:	a1 50 0f 00 00       	mov    0xf50,%eax
{
 ...
 a0d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 a0f:	a3 50 0f 00 00       	mov    %eax,0xf50
}
 a14:	5b                   	pop    %ebx
 a15:	5e                   	pop    %esi
 a16:	5f                   	pop    %edi
 ...
 a26:	72 ce                	jb     9f6 <free+0x26>
{
 ...
 a47:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 a4a:	a3 50 0f 00 00       	mov    %eax,0xf50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a69:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a6c:	8b 15 50 0f 00 00    	mov    0xf50,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 aaf:	73 47                	jae    af8 <malloc+0x98>
    ...
    if(p == freep)
 ab1:	39 05 50 0f 00 00    	cmp    %eax,0xf50
 ...
 ad6:	e8 f5 fe ff ff       	call   9d0 <free>
  return freep;
 adb:	8b 15 50 0f 00 00    	mov    0xf50,%edx
 ...
 b04:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 b07:	89 15 50 0f 00 00    	mov    %edx,0xf50
}
 ...
 b19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 b20:	c7 05 50 0f 00 00 54 	movl   $0xf54,0xf50
 b27:	0f 00 00 
 b2a:	c7 05 54 0f 00 00 54 	movl   $0xf54,0xf54
 b31:	0f 00 00 
    base.s.size = 0;
 b34:	b8 54 0f 00 00       	mov    $0xf54,%eax
 b39:	c7 05 58 0f 00 00 00 	movl   $0x0,0xf58
 b40:	00 00 00 
